...
emmeans(density.glmm, pairwise ~ substrate | treatment, adjust = "tukey")

# Posthoc test for comparing treatments within a substrate
emmeans(density.glmm, pairwise ~ treatment | substrate, adjust = "tukey")


# Check residuals
hist(residuals(density.glmm))
car::qqPlot(residuals(density.glmm))

# Plot model predictions and create dataframe 
plot(ggpredict(density.glmm, terms = ~substrate*treatment))
density.predictions <- as.data.frame(ggpredict(density.glmm, terms = ~substrate*treatment))
